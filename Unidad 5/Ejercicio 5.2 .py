...
Indicar si esta se trata de un palindromo 
(ej: reconocer, neuquen, amor a roma)
No deben aparecer y se deben tener en cuenta todos los 
posibles errores
"""
...
def es_palindromo():
  ...
  if not palabra_original.isalpha():
    ...
    palabra_reversa = palabra_original_lista.copy() #se le hace una copia porque me pisa la orginar el revers
