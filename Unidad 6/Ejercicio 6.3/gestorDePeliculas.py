...
lista_peliculas = []
lista_genero = ["Comedia","Accion","Drama","Terror","Suspenso","Ciencia ficcion","Infantil"]
...
class GestorDePeliculas:
    ...
    def crear_peliculas(self):
        ...
        nombre_intancia = pl.Peliculas(nombre,año,genero,nacionalidad,puntuacion)
            ...
            for pelicula in lista_peliculas: #reocorro la lista de peliculas
                ...
                if pelicula.nombre == nuevo_nombre:
                    while True:
                        ...
                        if nuevo_genero in lista_genero: #verificamos que el genero este dentro de la lista
